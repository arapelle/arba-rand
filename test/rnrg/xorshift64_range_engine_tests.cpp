...
TEST(xorshift64_range_engine_tests, constructor__positive_seed__ok)
{
...
TEST(xorshift64_range_engine_tests, constructor__null_seed__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
...
TEST(xorshift64_range_engine_tests, generate_random_ints__endianness_specific__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<4>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_range_engine_tests, generate_random_bytes__endianness_specific__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<4>;
    using integer_t = random_number_range_generator_t::integer_type;
    constexpr std::size_t number_of_seeds = random_number_range_generator_t::number_of_seeds;
...
TEST(xorshift64_range_engine_tests, determinist_generating__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_range_engine_tests, generate_random__endianness_neutral__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_engine_tests, seed__s__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_range_engine_tests, discard__n__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_range_engine_tests, generate_random_xorshift64__bytes__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
...
TEST(xorshift64_range_engine_tests, generate_random_xorshift64__ints__ok)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
    using integer_t = random_number_range_generator_t::integer_type;
    ...
    rand::generate_random_xorshift64(std::span(beta_ints), seed, cppx::endianness_specific);
    ASSERT_TRUE(std::ranges::equal(alpha_ints, beta_ints));
}

TEST(xorshift64_range_engine_tests, rnrg_benchmark)
{
    using random_number_range_generator_t = rand::xorshift64_range_engine<>;
